...
// window.addEventListener('scroll', () => { console.log(this.screenY) })

/*=============== SHOW SCROLL UP ===============*/
const scrollUp = () => {
  const scrollUp = document.getElementById('scroll-up')
  //When the scroll is higher than 350 viewport height, add the show-scroll class to the a tag with the scrollUp
  window.pageYOffset >= 350 ? scrollUp.classList.add('show-scroll')
...
//We obtain the theme that the interface has by validating the dark-theme class
